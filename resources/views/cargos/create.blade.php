            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <span>@lang('Cadastrando novo Cargo')</span>
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['action' =>'CargoController@store', 'method' => 'POST'])!!}

                    <div class="form-group">
                        {!! Form::label(__('Nome do Cargo:')) !!}
                        {!! Form::text("nome_cargo", null ,["class"=>"form-control","required"=>"required"]) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label(__('Descrição:')) !!}
                        {!! Form::text("desc_cargo", null ,["class"=>"form-control","required"=>"required"]) !!}
                    </div>
