            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <span>@lang('Editar cadastro de Convenio')</span>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {!! Form::label(__('Sigla do Convenio:')) !!}
                        {!! Form::text("perccons_conv", $convenio->perccons_conv ,["class"=>"form-control mmss","required"=>"required"]) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label(__('Observação:')) !!}
                        {!! Form::text("percexame_conv", $convenio->percexame_conv ,["class"=>"form-control mmss","required"=>"required"]) !!}
                    </div>
