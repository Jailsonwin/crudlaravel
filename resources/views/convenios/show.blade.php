...
@section('title',__($convenio->nome . ': CRUD Laravel'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <span><span class="text-info">{{$convenio->nome}}</span>Visualizando Convenio</span>
                ...
                <div class="card-body">
                    ...
                    <table class="w3-table-all notranslate" width="100%" border="1">
                        ...
                        <tr>
                            <th align="left"><strong>@lang('Nome da Convenio')</strong>:</th>
                        ...
                        <tr>
                            <th align="left"><strong>@lang('Sigla da Convenio')</strong>:</th>
                            <th align="left">{{$convenio->perccons_conv}}</th>
                          </tr>
                          <tr>
                            <th align="left"><strong>@lang('Observação da Convenio')</strong>:</th>
