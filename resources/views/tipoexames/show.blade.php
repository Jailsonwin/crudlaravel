...
@section('title',__($tipoexame->nome . ': CRUD Laravel'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <span><span class="text-info">{{$tipoexame->nome}}</span>Visualizando Tipoexame</span>
                ...
                <div class="card-body">
                    ...
                    <table class="w3-table-all notranslate" width="100%" border="1">
                        ...
                        <tr>
                            <th align="left"><strong>@lang('Nome do Tipoexame')</strong>:</th>
                            <th align="left">{{$tipoexame->nome_tpex}}</th>
                        </tr>
                        <tr>
                            <th align="left"><strong>@lang('Sigla do Tipoexame')</strong>:</th>
                            <th align="left">{{$tipoexame->sigla_tpex}}</th>
                        </tr>
                        <tr>
                            <th align="left"><strong>@lang('Descrição do  Tipoexame')</strong>:</th>
