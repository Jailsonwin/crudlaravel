...
@section('title',__($especialidade->nome . ': CRUD Laravel'))
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between w-100">
                        <span><span class="text-info">{{$especialidade->nome}}</span>Visualizando Especialidade</span>
                ...
                <div class="card-body">
                    ...
                    <table class="w3-table-all notranslate" width="100%" border="1">
                        ...
                        <tr>
                          ...
                          <tr>
                            <th align="left"><strong>@lang('Observação da Especialidade')</strong>:</th>
