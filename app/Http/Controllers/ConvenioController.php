...
class ConvenioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validateData = $request->validate([
            'nome_conv'      =>      'required|max:200',
            'fone_conv'      =>      'required|max:200',
            'site_conv'      =>      'required|max:200',
            'contato_conv'   =>      'required|max:200',
            'perccons_conv'  =>      'required|max:200',
            'percexame_conv' =>      'required|max:200'
        ]);
